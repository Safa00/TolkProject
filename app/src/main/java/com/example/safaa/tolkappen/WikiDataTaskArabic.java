...
public class WikiDataTaskArabic extends AsyncTask<String, String, String> {
    private MainActivity mImportFragment;
    private ArrayList<String> mLinks = new ArrayList<String>();

    public WikiDataTaskArabic(MainActivity importFragment){
    ...
    protected String doInBackground(String... params) {
        ...
        try{
            URL url = new URL("http://128.199.46.182/wiki/dokuwiki-2017-02-19e/doku.php?id=information:arabisk:filer");
    ...
    protected void onPostExecute(String s) {
        ...
        mImportFragment.updateAdapterArabic(mLinks);
    }
